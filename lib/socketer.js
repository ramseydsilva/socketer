...
module.exports = (function () {
     ...
     */
    var getUrl = function(app, url, protocol) {
     ...
     * @param {Object} callback A callback to run on completion. Supplies anonymous socket
     */
    var anonSocket = function (app, logoutUrl, callback){
        if (!callback) {
            callback = logoutUrl;
            logoutUrl = '/logout';
        }
     ...
     * @param {Object} callback A callback to run on completion. Supplies authenticated socket
     */
    var authSocket = function(app, credentials, loginUrl, callback) {
        if (!callback) {
            callback = loginUrl;
            loginUrl = '/login';
        }
     ...
     * @param {Object} callback Supplies callback response form the anonymous get request
     */
    var anonRequest = function(app, url, logoutUrl, callback) {
        if (!callback) {
            callback = logoutUrl;
            logoutUrl = '/logout';
        }
     ...
     * @param {Object} callback Supplies callback response form the anonymous get request
     */
    var authRequest = function(app, url, credentials, loginUrl, callback) {
        if (!callback) {
            callback = loginUrl;
            loginUrl = '/login';
        }
